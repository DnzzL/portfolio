  ...
  return (
    <header className="text-gray-600 body-font">
      <div className="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center">
        ...
        <span className="inline-flex sm:ml-auto sm:mt-0 mt-2 justify-center sm:justify-start p-5">
          <a
        ...
        <nav className="md:ml-auto flex flex-wrap items-center text-base justify-center">
          <a className="mr-5 hover:text-gray-900 text-xl" href="/">
            Home
          </a>
          <a className="mr-5 hover:text-gray-900 text-xl" href="/blog">
            Blog
          </a>
          <a className="mr-5 hover:text-gray-900 text-xl" href="/about">
            About Me
          </a>
        </nav>
      </div>
